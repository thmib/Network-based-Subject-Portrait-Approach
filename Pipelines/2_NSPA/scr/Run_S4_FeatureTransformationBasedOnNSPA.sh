...
python crossvalidation_split.py Allnodes.csv $num_folds $seed
...
python translate_edge_list.py Alledges.edgelist Allnodes.csv

# compute the delta degree of each dataset
echo "Compute the delta degrees of traning dataset"
head -n 1 Allnodes.csv > header.csv # prepare the header
